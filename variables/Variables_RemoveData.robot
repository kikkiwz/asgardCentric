...
#-------------------------------------------- RemoveAWorker --------------------------------------------#	
#path url remove
${URL_REMOVEAWORKER}    /api/v1/Workers/

#header RemoveThing
${HEADER_X_AIS_ORDERREF_REMOVEAWORKER}    RemoveAWorker_
${HEADER_X_AIS_ORDERDESC_REMOVEAWORKER}    RemoveAWorker

#request name
${REMOVEAWORKER}    RemoveAWorker

#response description
${VALUE_DESCRIPTION_REMOVEAWORKER_SUCCESS}    The requested operation was successfully.
