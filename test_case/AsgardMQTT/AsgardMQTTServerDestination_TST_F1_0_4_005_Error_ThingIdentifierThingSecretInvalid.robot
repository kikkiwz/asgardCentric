...
*** Test Cases ***
################### Post ###################
AsgardMQTTServerDestination_TST_F1_0_4_005_Error_ThingIdentifierThingSecretInvalid
    ...
    ${ThingSecret}=    Set Variable    ${ASGARD_MQTT_SERVERDESTINATION_VALUE_THINGIDENTIFIER_INVALID}
