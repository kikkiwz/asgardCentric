...
*** Test Cases ***
################### Post ###################
CoapAppServerDestination_TST_F1_0_2_003_Error_ThingIdentifierThingSecretNotFound
	...
	${ThingSecret}=    Set Variable    ${ASGARD_COAPAPP_SERVERDESTINATION_VALUE_THINGIDENTIFIER_NOTFOUND}
