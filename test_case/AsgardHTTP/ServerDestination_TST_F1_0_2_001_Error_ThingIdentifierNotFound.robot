...
*** Test Cases ***
################### Post ###################
ServerDestination_TTST_F1_0_2_001_Error_ThingIdentifierNotFound
	...
	${ThingIdentifier}=    Set Variable    ${ASGARD_HTTP_SERVERDESTINATION_VALUE_THINGIDENTIFIER_NOTFOUND}
