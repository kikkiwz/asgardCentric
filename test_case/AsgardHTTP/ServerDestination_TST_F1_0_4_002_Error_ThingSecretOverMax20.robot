...
*** Test Cases ***
################### Post ###################
ServerDestination_TST_F1_0_4_002_Error_ThingSecretOverMax20 
    ...
    #Check Details
	${responseDetails}=    Set Variable    [{'Target': 'ThingSecret', 'DeveloperMessage': "${VALUE_DETAILS_DEVELOPERMESSAGE_RESPONSE_THINGSECRET_LENGTHMUSTMEMORETHAN_ERROR}"}]
    ...
    ${responseObjectDetail}=    Set Variable    [{"Target":"ThingSecret","DeveloperMessage":"${VALUE_DETAILS_DEVELOPERMESSAGE_LOG_THINGSECRET_LENGTHMUSTMEMOREMORETHAN_ERROR}"}]
