...
*** Test Cases ***
################### Post ###################
ServerDestination_TST_F1_0_4_000_Error_ThingIdentifierOverMax19 
	...
	${createResponse}=    Request CreateData for get WorkerId ThingId and ActivateThings    ${ThingIdentifierCreate}    ${ThingSecret}    ${IMEI}
    ...
    #Check Details
	${responseDetails}=    Set Variable    [{'Target': 'ThingIdentifier', 'DeveloperMessage': "${VALUE_DETAILS_DEVELOPERMESSAGE_RESPONSE_THINGIDENTIFIER_LENGTHMUSTMEMORETHAN_ERROR}"}]
    ...
    ${responseObjectDetail}=    Set Variable    [{"Target":"ThingIdentifier","DeveloperMessage":"${VALUE_DETAILS_DEVELOPERMESSAGE_LOG_THINGIDENTIFIER_LENGTHMUSTMEMOREMORETHAN_ERROR}"}]
