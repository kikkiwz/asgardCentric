...
*** Test Cases ***
################### Post ###################
ServerDestination_TST_F1_0_4_001_Error_ThingIdentifierLessThan19 
    ...
    #Check Details
	${responseDetails}=    Set Variable    [{'Target': 'ThingIdentifier', 'DeveloperMessage': "${VALUE_DETAILS_DEVELOPERMESSAGE_RESPONSE_THINGIDENTIFIER_LENGTHMUSTMELESSTHAN_ERROR}"}]
    ...
    ${responseObjectDetail}=    Set Variable    [{"Target":"ThingIdentifier","DeveloperMessage":"${VALUE_DETAILS_DEVELOPERMESSAGE_LOG_THINGIDENTIFIER_LENGTHMUSTMELESSTHAN_ERROR}"}]
