...
*** Test Cases ***
################### Post ###################
ServerDestination_TST_F1_0_4_004_Error_ThingSecretInvalid 
    ...
    #Check Details
	${responseDetails}=    Set Variable    [{'Target': 'ThingSecret', 'DeveloperMessage': '${VALUE_DETAILS_DEVELOPERMESSAGE_THINGSECRETMUSTNOTBEEMPTY_ERROR}'}]
    ...
    ${identity}=    Set Variable    {\"ThingIdentifier\":\"${ThingIdentifier}\",\"ThingSecret\":\" \"}
