...
Inquiry Thing
    ...
    ${res}=    Run keyword And Continue On Failure    Post Api Request    ${url}${PROVISIONINGAPIS}    ${URL_INQUIRYTHING}    ${headers}    ${data}
	#Log To Console    res${res}
	Run keyword And Continue On Failure    Response ResultCode Should Have    ${res}    ${INQUIRYTHING}    ${FIELD_OPERATIONSTATUS}    ${FIELD_CODE}    ${FIELD_DESCRIPTION}
	[return]    ${res}
...
Inquiry ConfigGroup
    ...
    ${res}=    Run keyword And Continue On Failure    Post Api Request    ${url}${PROVISIONINGAPIS}    ${URL_INQUIRYCONFIGGROUP}    ${headers}    ${data}
	#Log To Console    res${res}
	Run keyword And Continue On Failure    Response ResultCode Should Have    ${res}    ${INQUIRYCONFIGGROUP}    ${FIELD_OPERATIONSTATUS}    ${FIELD_CODE}    ${FIELD_DESCRIPTION}
	[return]    ${res}
...
Inquiry Account
    ...
    ${res}=    Run keyword And Continue On Failure    Post Api Request    ${url}${PROVISIONINGAPIS}    ${URL_INQUIRYACCOUNT}    ${headers}    ${data}
	#Log To Console    res${res}
	Run keyword And Continue On Failure    Response ResultCode Should Have    ${res}    ${INQUIRYACCOUNT}    ${FIELD_OPERATIONSTATUS}    ${FIELD_CODE}    ${FIELD_DESCRIPTION}
